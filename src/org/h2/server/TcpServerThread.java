...
public class TcpServerThread implements Runnable {
    ...
    public void run() {
        try {
            System.out.println("TcpServerThread : 76 : ");
            transfer.init();
            trace("Connect");
    ...
    private void process() throws IOException {
        ...
        System.out.println("TcpServerThread : 272 : "+operation);
        switch (operation) {
        ...
        case SessionRemote.SESSION_PREPARE: {
            ...
            System.out.println("TcpServerThread : 278 : sql :"+sql);
            Command command = session.prepareLocal(sql);
            boolean readonly = command.isReadOnly();
            cache.addObject(id, command);
            boolean isQuery = command.isQuery();
            System.out.println("TcpServerThread : 283 : readonly :"+readonly);
        ...
        case SessionRemote.COMMAND_EXECUTE_QUERY: {
            System.out.println("TcpServerThread : 333 : ");
            int id = transfer.readInt();
            int objectId = transfer.readInt();
            ...
            synchronized (session) {
                System.out.println("TcpServerThread : 343 : hello ");
